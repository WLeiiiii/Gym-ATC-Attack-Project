...
class SimpleEnv(gym.Env):
    ...
    def _terminal_reward(self):
        ...
        if conflict:
            self.conflict_num += 1
            return [Config.conflict_penalty, Config.conflict_penalty], False, 'c'  # conflict
        ...
        if Config.sparse_reward:
            return [Config.step_penalty, Config.step_penalty], False, ''
        else:
            return [-dist(self.drone, self.goal) / 2400, -dist(self.drone, self.goal) / 2400], False, ''
            # return -1000, False, ''
