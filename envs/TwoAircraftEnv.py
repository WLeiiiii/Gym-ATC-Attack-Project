...
class TwoAircraftEnv(gym.Env):
    def __init__(self):
        ...
        state_dimension = self.intruder_size * 6 + 6
    ...
    def render(self, mode="human"):
        ...
        # draw ownship
        ownship_img = rendering.Image(os.path.join(__location__, 'images/intruder.png'), 32, 32)
        ...
        # draw intruders
        for aircraft in self.intruder_list:
            intruder_img = rendering.Image(os.path.join(__location__, 'images/aircraft.png'), 32, 32)
    ...
    def reset_intruder(self):
        ...
        for i in range(self.intruder_size):
            ...
            position = pos_list[rand]
            speed = np.random.uniform(low=self.min_speed, high=self.max_speed),
            # speed = (self.min_speed + self.max_speed) / 2
            heading = head_list[rand]
