...
def main():
    ...
    parser.add_argument('--save_path_j', type=str, default='../save_model_new/2dqn_5lines_model_01_j.pth')
    parser.add_argument('--save_path_p', type=str, default='../save_model_new/2dqn_5lines_model_01_p.pth')
