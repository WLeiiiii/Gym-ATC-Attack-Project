...
def evaluate(env, agent, load_path_c, load_path_g):
    ...
    display_plt(total_rewards_c, 'Episode', 'Score', "DQN_j")
    display_plt(total_rewards_g, 'Episode', 'Score', "DQN_p")
    pass
...
def main():
    ...
    parser.add_argument('--save_path_c', type=str, default='../save_model_new/2dqn_5lines_model_01_c.pth')
    parser.add_argument('--save_path_g', type=str, default='../save_model_new/2dqn_5lines_model_01_g.pth')
    parser.add_argument('--load_path_c', type=str, default='../save_model_new/2dqn_5lines_model_01_c.pth')
    ...
    if args.train:
        train(env, agent, n_episodes=args.episodes, save_path_c=args.save_path_c, save_path_g=args.save_path_g)
