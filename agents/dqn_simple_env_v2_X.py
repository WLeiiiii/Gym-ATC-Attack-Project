...
def main():
    ...
    parser.add_argument('--save_path_c', type=str, default='../save_model/2dqn_Xlines_model_01_c.pth')
    parser.add_argument('--save_path_g', type=str, default='../save_model/2dqn_Xlines_model_01_g.pth')
    parser.add_argument('--load_path_c', type=str, default='../save_model/2dqn_Xlines_model_01_c.pth')
    parser.add_argument('--load_path_g', type=str, default='../save_model/2dqn_Xlines_model_01_g.pth')
